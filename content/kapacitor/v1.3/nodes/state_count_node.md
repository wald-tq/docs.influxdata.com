...
|:----------|:--|
| **[stateCount](#example)( predicate `lambda`)** | _predicate_ is the expression to use to determine whether or not a state is active. |

**Property Methods**

| Setters | Description |
|:-----------|:---|
| **[as](#as)( name `string` )**  | _name_ is the alternate name to use for the result. |
...
-	[As](/kapacitor/v1.3/nodes/state_count_node/#as)

### Chaining Methods

-	[Alert](/kapacitor/v1.3/nodes/state_count_node/#alert)
-	[Bottom](/kapacitor/v1.3/nodes/state_count_node/#bottom)
-	[Combine](/kapacitor/v1.3/nodes/state_count_node/#combine)
-	[Count](/kapacitor/v1.3/nodes/state_count_node/#count)
-	[CumulativeSum](/kapacitor/v1.3/nodes/state_count_node/#cumulativesum)
-	[Deadman](/kapacitor/v1.3/nodes/state_count_node/#deadman)
-	[Default](/kapacitor/v1.3/nodes/state_count_node/#default)
-	[Delete](/kapacitor/v1.3/nodes/state_count_node/#delete)
-	[Derivative](/kapacitor/v1.3/nodes/state_count_node/#derivative)
-	[Difference](/kapacitor/v1.3/nodes/state_count_node/#difference)
-	[Distinct](/kapacitor/v1.3/nodes/state_count_node/#distinct)
-	[Elapsed](/kapacitor/v1.3/nodes/state_count_node/#elapsed)
-	[Eval](/kapacitor/v1.3/nodes/state_count_node/#eval)
-	[First](/kapacitor/v1.3/nodes/state_count_node/#first)
-	[Flatten](/kapacitor/v1.3/nodes/state_count_node/#flatten)
-	[GroupBy](/kapacitor/v1.3/nodes/state_count_node/#groupby)
-	[HoltWinters](/kapacitor/v1.3/nodes/state_count_node/#holtwinters)
-	[HoltWintersWithFit](/kapacitor/v1.3/nodes/state_count_node/#holtwinterswithfit)
-	[HttpOut](/kapacitor/v1.3/nodes/state_count_node/#httpout)
-	[HttpPost](/kapacitor/v1.3/nodes/state_count_node/#httppost)
-	[InfluxDBOut](/kapacitor/v1.3/nodes/state_count_node/#influxdbout)
-	[Join](/kapacitor/v1.3/nodes/state_count_node/#join)
-	[K8sAutoscale](/kapacitor/v1.3/nodes/state_count_node/#k8sautoscale)
-	[KapacitorLoopback](/kapacitor/v1.3/nodes/state_count_node/#kapacitorloopback)
-	[Last](/kapacitor/v1.3/nodes/state_count_node/#last)
-	[Log](/kapacitor/v1.3/nodes/state_count_node/#log)
-	[Max](/kapacitor/v1.3/nodes/state_count_node/#max)
-	[Mean](/kapacitor/v1.3/nodes/state_count_node/#mean)
-	[Median](/kapacitor/v1.3/nodes/state_count_node/#median)
-	[Min](/kapacitor/v1.3/nodes/state_count_node/#min)
-	[Mode](/kapacitor/v1.3/nodes/state_count_node/#mode)
-	[MovingAverage](/kapacitor/v1.3/nodes/state_count_node/#movingaverage)
-	[Percentile](/kapacitor/v1.3/nodes/state_count_node/#percentile)
-	[Sample](/kapacitor/v1.3/nodes/state_count_node/#sample)
-	[Shift](/kapacitor/v1.3/nodes/state_count_node/#shift)
-	[Spread](/kapacitor/v1.3/nodes/state_count_node/#spread)
-	[StateCount](/kapacitor/v1.3/nodes/state_count_node/#statecount)
-	[StateDuration](/kapacitor/v1.3/nodes/state_count_node/#stateduration)
-	[Stats](/kapacitor/v1.3/nodes/state_count_node/#stats)
-	[Stddev](/kapacitor/v1.3/nodes/state_count_node/#stddev)
-	[Sum](/kapacitor/v1.3/nodes/state_count_node/#sum)
-	[Top](/kapacitor/v1.3/nodes/state_count_node/#top)
-	[Union](/kapacitor/v1.3/nodes/state_count_node/#union)
-	[Where](/kapacitor/v1.3/nodes/state_count_node/#where)
-	[Window](/kapacitor/v1.3/nodes/state_count_node/#window)
-->
