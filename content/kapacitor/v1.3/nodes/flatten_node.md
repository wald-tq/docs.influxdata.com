...
|:----------|:--|
| **[flatten](#example)()** | Chaining method takes no arguments   |

**Property Methods**

| Setters | Description |
|:-----------|:---|
| **[delimiter](#delimiter)( delim `string`)** | _delim_ is the delimiter to use between field name parts. |
| **[dropOriginalFieldName](#droporiginalfieldname)()** | Takes no arguments.  Sets a flag to indicate that the original field name should not be included in the final field name. |
| **[on](#on)( dims `[]string`)** | _dims_ are the dimensions on which to join the fields.  |
| **[tolerance](#tolerance)( delta `duration`)** | _delta_ is the maximum duration that two incoming points can be apart and still be considered equal in time. |
...
-	[Delimiter](/kapacitor/v1.3/nodes/flatten_node/#delimiter)
-	[DropOriginalFieldName](/kapacitor/v1.3/nodes/flatten_node/#droporiginalfieldname)
-	[On](/kapacitor/v1.3/nodes/flatten_node/#on)
-	[Tolerance](/kapacitor/v1.3/nodes/flatten_node/#tolerance)

### Chaining Methods

-	[Alert](/kapacitor/v1.3/nodes/flatten_node/#alert)
-	[Bottom](/kapacitor/v1.3/nodes/flatten_node/#bottom)
-	[Combine](/kapacitor/v1.3/nodes/flatten_node/#combine)
-	[Count](/kapacitor/v1.3/nodes/flatten_node/#count)
-	[CumulativeSum](/kapacitor/v1.3/nodes/flatten_node/#cumulativesum)
-	[Deadman](/kapacitor/v1.3/nodes/flatten_node/#deadman)
-	[Default](/kapacitor/v1.3/nodes/flatten_node/#default)
-	[Delete](/kapacitor/v1.3/nodes/flatten_node/#delete)
-	[Derivative](/kapacitor/v1.3/nodes/flatten_node/#derivative)
-	[Difference](/kapacitor/v1.3/nodes/flatten_node/#difference)
-	[Distinct](/kapacitor/v1.3/nodes/flatten_node/#distinct)
-	[Elapsed](/kapacitor/v1.3/nodes/flatten_node/#elapsed)
-	[Eval](/kapacitor/v1.3/nodes/flatten_node/#eval)
-	[First](/kapacitor/v1.3/nodes/flatten_node/#first)
-	[Flatten](/kapacitor/v1.3/nodes/flatten_node/#flatten)
-	[GroupBy](/kapacitor/v1.3/nodes/flatten_node/#groupby)
-	[HoltWinters](/kapacitor/v1.3/nodes/flatten_node/#holtwinters)
-	[HoltWintersWithFit](/kapacitor/v1.3/nodes/flatten_node/#holtwinterswithfit)
-	[HttpOut](/kapacitor/v1.3/nodes/flatten_node/#httpout)
-	[HttpPost](/kapacitor/v1.3/nodes/flatten_node/#httppost)
-	[InfluxDBOut](/kapacitor/v1.3/nodes/flatten_node/#influxdbout)
-	[Join](/kapacitor/v1.3/nodes/flatten_node/#join)
-	[K8sAutoscale](/kapacitor/v1.3/nodes/flatten_node/#k8sautoscale)
-	[KapacitorLoopback](/kapacitor/v1.3/nodes/flatten_node/#kapacitorloopback)
-	[Last](/kapacitor/v1.3/nodes/flatten_node/#last)
-	[Log](/kapacitor/v1.3/nodes/flatten_node/#log)
-	[Max](/kapacitor/v1.3/nodes/flatten_node/#max)
-	[Mean](/kapacitor/v1.3/nodes/flatten_node/#mean)
-	[Median](/kapacitor/v1.3/nodes/flatten_node/#median)
-	[Min](/kapacitor/v1.3/nodes/flatten_node/#min)
-	[Mode](/kapacitor/v1.3/nodes/flatten_node/#mode)
-	[MovingAverage](/kapacitor/v1.3/nodes/flatten_node/#movingaverage)
-	[Percentile](/kapacitor/v1.3/nodes/flatten_node/#percentile)
-	[Sample](/kapacitor/v1.3/nodes/flatten_node/#sample)
-	[Shift](/kapacitor/v1.3/nodes/flatten_node/#shift)
-	[Spread](/kapacitor/v1.3/nodes/flatten_node/#spread)
-	[StateCount](/kapacitor/v1.3/nodes/flatten_node/#statecount)
-	[StateDuration](/kapacitor/v1.3/nodes/flatten_node/#stateduration)
-	[Stats](/kapacitor/v1.3/nodes/flatten_node/#stats)
-	[Stddev](/kapacitor/v1.3/nodes/flatten_node/#stddev)
-	[Sum](/kapacitor/v1.3/nodes/flatten_node/#sum)
-	[Top](/kapacitor/v1.3/nodes/flatten_node/#top)
-	[Union](/kapacitor/v1.3/nodes/flatten_node/#union)
-	[Where](/kapacitor/v1.3/nodes/flatten_node/#where)
-	[Window](/kapacitor/v1.3/nodes/flatten_node/#window)
-->
...
```javascript
node.dropOriginalFieldName(drop ...bool)
```
