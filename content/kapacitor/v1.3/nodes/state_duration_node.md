...
|:----------|:--|
| **[stateDuration](#example)( predicate `lambda`)** | _predicate_ defines the state to be tested. |

**Property Methods**

| Setters | Description |
|:-----------|:---|
| **[as](#as)( name `string`)** | _name_ is the name of the new field used to hold the duration value.  Default is the name of the node, i.e. 'state_duration'.  |
| **[unit](#unit)( tu `duration` )** | _tu_ is the time unit of the resulting duration value.  |
