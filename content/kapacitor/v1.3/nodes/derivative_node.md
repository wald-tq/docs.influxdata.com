...
|:----------|:--|
| **[derivative](#example)( field `string`)** | _field_ names the data field for which the derivative will be calculated. |

**Property Methods**

| Setters | Description |
|:-----------|:---|
| **[as](#as)( name `string`)** | _name_ is the name of the new field to hold the derivative. |
| **[nonNegative](#nonnegative)()** | Takes no arguments.  Sets a flag to indicate that negative results are to be skipped. |
| **[unit](#unit)( unit `duration`)** | _unit_ is the time unit of the resulting derivative value. |
...
-	[As](/kapacitor/v1.3/nodes/derivative_node/#as)
-	[NonNegative](/kapacitor/v1.3/nodes/derivative_node/#nonnegative)
-	[Unit](/kapacitor/v1.3/nodes/derivative_node/#unit)

### Chaining Methods

-	[Alert](/kapacitor/v1.3/nodes/derivative_node/#alert)
-	[Bottom](/kapacitor/v1.3/nodes/derivative_node/#bottom)
-	[Combine](/kapacitor/v1.3/nodes/derivative_node/#combine)
-	[Count](/kapacitor/v1.3/nodes/derivative_node/#count)
-	[CumulativeSum](/kapacitor/v1.3/nodes/derivative_node/#cumulativesum)
-	[Deadman](/kapacitor/v1.3/nodes/derivative_node/#deadman)
-	[Default](/kapacitor/v1.3/nodes/derivative_node/#default)
-	[Delete](/kapacitor/v1.3/nodes/derivative_node/#delete)
-	[Derivative](/kapacitor/v1.3/nodes/derivative_node/#derivative)
-	[Difference](/kapacitor/v1.3/nodes/derivative_node/#difference)
-	[Distinct](/kapacitor/v1.3/nodes/derivative_node/#distinct)
-	[Elapsed](/kapacitor/v1.3/nodes/derivative_node/#elapsed)
-	[Eval](/kapacitor/v1.3/nodes/derivative_node/#eval)
-	[First](/kapacitor/v1.3/nodes/derivative_node/#first)
-	[Flatten](/kapacitor/v1.3/nodes/derivative_node/#flatten)
-	[GroupBy](/kapacitor/v1.3/nodes/derivative_node/#groupby)
-	[HoltWinters](/kapacitor/v1.3/nodes/derivative_node/#holtwinters)
-	[HoltWintersWithFit](/kapacitor/v1.3/nodes/derivative_node/#holtwinterswithfit)
-	[HttpOut](/kapacitor/v1.3/nodes/derivative_node/#httpout)
-	[HttpPost](/kapacitor/v1.3/nodes/derivative_node/#httppost)
-	[InfluxDBOut](/kapacitor/v1.3/nodes/derivative_node/#influxdbout)
-	[Join](/kapacitor/v1.3/nodes/derivative_node/#join)
-	[K8sAutoscale](/kapacitor/v1.3/nodes/derivative_node/#k8sautoscale)
-	[KapacitorLoopback](/kapacitor/v1.3/nodes/derivative_node/#kapacitorloopback)
-	[Last](/kapacitor/v1.3/nodes/derivative_node/#last)
-	[Log](/kapacitor/v1.3/nodes/derivative_node/#log)
-	[Max](/kapacitor/v1.3/nodes/derivative_node/#max)
-	[Mean](/kapacitor/v1.3/nodes/derivative_node/#mean)
-	[Median](/kapacitor/v1.3/nodes/derivative_node/#median)
-	[Min](/kapacitor/v1.3/nodes/derivative_node/#min)
-	[Mode](/kapacitor/v1.3/nodes/derivative_node/#mode)
-	[MovingAverage](/kapacitor/v1.3/nodes/derivative_node/#movingaverage)
-	[Percentile](/kapacitor/v1.3/nodes/derivative_node/#percentile)
-	[Sample](/kapacitor/v1.3/nodes/derivative_node/#sample)
-	[Shift](/kapacitor/v1.3/nodes/derivative_node/#shift)
-	[Spread](/kapacitor/v1.3/nodes/derivative_node/#spread)
-	[StateCount](/kapacitor/v1.3/nodes/derivative_node/#statecount)
-	[StateDuration](/kapacitor/v1.3/nodes/derivative_node/#stateduration)
-	[Stats](/kapacitor/v1.3/nodes/derivative_node/#stats)
-	[Stddev](/kapacitor/v1.3/nodes/derivative_node/#stddev)
-	[Sum](/kapacitor/v1.3/nodes/derivative_node/#sum)
-	[Top](/kapacitor/v1.3/nodes/derivative_node/#top)
-	[Union](/kapacitor/v1.3/nodes/derivative_node/#union)
-	[Where](/kapacitor/v1.3/nodes/derivative_node/#where)
-	[Window](/kapacitor/v1.3/nodes/derivative_node/#window)
-->
