...
|:----------|:--|
| **[delete](#example)()** | Chaining method takes no arguments   |

**Property Methods**

| Setters | Description |
|:-----------|:---|
| **[field](#field)( name `string`)** | _name_ defines the name of a field to be deleted. <br/> This setter can be called more than once to delete more than one field. |
| **[tag](#tag)( name `string` )** | _name_ defines the name of a tag to be deleted.  <br/> This setter can be called more than once to delete more than one tag. |
...
-	[Field](/kapacitor/v1.3/nodes/delete_node/#field)
-	[Tag](/kapacitor/v1.3/nodes/delete_node/#tag)

### Chaining Methods

-	[Alert](/kapacitor/v1.3/nodes/delete_node/#alert)
-	[Bottom](/kapacitor/v1.3/nodes/delete_node/#bottom)
-	[Combine](/kapacitor/v1.3/nodes/delete_node/#combine)
-	[Count](/kapacitor/v1.3/nodes/delete_node/#count)
-	[CumulativeSum](/kapacitor/v1.3/nodes/delete_node/#cumulativesum)
-	[Deadman](/kapacitor/v1.3/nodes/delete_node/#deadman)
-	[Default](/kapacitor/v1.3/nodes/delete_node/#default)
-	[Delete](/kapacitor/v1.3/nodes/delete_node/#delete)
-	[Derivative](/kapacitor/v1.3/nodes/delete_node/#derivative)
-	[Difference](/kapacitor/v1.3/nodes/delete_node/#difference)
-	[Distinct](/kapacitor/v1.3/nodes/delete_node/#distinct)
-	[Elapsed](/kapacitor/v1.3/nodes/delete_node/#elapsed)
-	[Eval](/kapacitor/v1.3/nodes/delete_node/#eval)
-	[First](/kapacitor/v1.3/nodes/delete_node/#first)
-	[Flatten](/kapacitor/v1.3/nodes/delete_node/#flatten)
-	[GroupBy](/kapacitor/v1.3/nodes/delete_node/#groupby)
-	[HoltWinters](/kapacitor/v1.3/nodes/delete_node/#holtwinters)
-	[HoltWintersWithFit](/kapacitor/v1.3/nodes/delete_node/#holtwinterswithfit)
-	[HttpOut](/kapacitor/v1.3/nodes/delete_node/#httpout)
-	[HttpPost](/kapacitor/v1.3/nodes/delete_node/#httppost)
-	[InfluxDBOut](/kapacitor/v1.3/nodes/delete_node/#influxdbout)
-	[Join](/kapacitor/v1.3/nodes/delete_node/#join)
-	[K8sAutoscale](/kapacitor/v1.3/nodes/delete_node/#k8sautoscale)
-	[KapacitorLoopback](/kapacitor/v1.3/nodes/delete_node/#kapacitorloopback)
-	[Last](/kapacitor/v1.3/nodes/delete_node/#last)
-	[Log](/kapacitor/v1.3/nodes/delete_node/#log)
-	[Max](/kapacitor/v1.3/nodes/delete_node/#max)
-	[Mean](/kapacitor/v1.3/nodes/delete_node/#mean)
-	[Median](/kapacitor/v1.3/nodes/delete_node/#median)
-	[Min](/kapacitor/v1.3/nodes/delete_node/#min)
-	[Mode](/kapacitor/v1.3/nodes/delete_node/#mode)
-	[MovingAverage](/kapacitor/v1.3/nodes/delete_node/#movingaverage)
-	[Percentile](/kapacitor/v1.3/nodes/delete_node/#percentile)
-	[Sample](/kapacitor/v1.3/nodes/delete_node/#sample)
-	[Shift](/kapacitor/v1.3/nodes/delete_node/#shift)
-	[Spread](/kapacitor/v1.3/nodes/delete_node/#spread)
-	[StateCount](/kapacitor/v1.3/nodes/delete_node/#statecount)
-	[StateDuration](/kapacitor/v1.3/nodes/delete_node/#stateduration)
-	[Stats](/kapacitor/v1.3/nodes/delete_node/#stats)
-	[Stddev](/kapacitor/v1.3/nodes/delete_node/#stddev)
-	[Sum](/kapacitor/v1.3/nodes/delete_node/#sum)
-	[Top](/kapacitor/v1.3/nodes/delete_node/#top)
-	[Union](/kapacitor/v1.3/nodes/delete_node/#union)
-	[Where](/kapacitor/v1.3/nodes/delete_node/#where)
-	[Window](/kapacitor/v1.3/nodes/delete_node/#window)
-->
