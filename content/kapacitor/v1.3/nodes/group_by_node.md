...
A [GroupByNode](/kapacitor/v1.3/nodes/group_by_node/) will group the incoming data.

**Standard Constructor**

| Signature |  Description |
|:----------|:--|
| **[groupBy](#example)( dims `[]interface`)** | _dims_ are the dimensions by which the data will be grouped. |

**Property Methods**

| Setters | Description |
|:-----------|:---|
| **[byMeasurement](#bymeasurement)()** | Takes no arguments.  Sets a flag to include the measurement in the group ID. |
...
-	[ByMeasurement](/kapacitor/v1.3/nodes/group_by_node/#bymeasurement)

### Chaining Methods

-	[Alert](/kapacitor/v1.3/nodes/group_by_node/#alert)
-	[Bottom](/kapacitor/v1.3/nodes/group_by_node/#bottom)
-	[Combine](/kapacitor/v1.3/nodes/group_by_node/#combine)
-	[Count](/kapacitor/v1.3/nodes/group_by_node/#count)
-	[CumulativeSum](/kapacitor/v1.3/nodes/group_by_node/#cumulativesum)
-	[Deadman](/kapacitor/v1.3/nodes/group_by_node/#deadman)
-	[Default](/kapacitor/v1.3/nodes/group_by_node/#default)
-	[Delete](/kapacitor/v1.3/nodes/group_by_node/#delete)
-	[Derivative](/kapacitor/v1.3/nodes/group_by_node/#derivative)
-	[Difference](/kapacitor/v1.3/nodes/group_by_node/#difference)
-	[Distinct](/kapacitor/v1.3/nodes/group_by_node/#distinct)
-	[Elapsed](/kapacitor/v1.3/nodes/group_by_node/#elapsed)
-	[Eval](/kapacitor/v1.3/nodes/group_by_node/#eval)
-	[Exclude](/kapacitor/v1.3/nodes/group_by_node/#exclude)
-	[First](/kapacitor/v1.3/nodes/group_by_node/#first)
-	[Flatten](/kapacitor/v1.3/nodes/group_by_node/#flatten)
-	[GroupBy](/kapacitor/v1.3/nodes/group_by_node/#groupby)
-	[HoltWinters](/kapacitor/v1.3/nodes/group_by_node/#holtwinters)
-	[HoltWintersWithFit](/kapacitor/v1.3/nodes/group_by_node/#holtwinterswithfit)
-	[HttpOut](/kapacitor/v1.3/nodes/group_by_node/#httpout)
-	[HttpPost](/kapacitor/v1.3/nodes/group_by_node/#httppost)
-	[InfluxDBOut](/kapacitor/v1.3/nodes/group_by_node/#influxdbout)
-	[Join](/kapacitor/v1.3/nodes/group_by_node/#join)
-	[K8sAutoscale](/kapacitor/v1.3/nodes/group_by_node/#k8sautoscale)
-	[KapacitorLoopback](/kapacitor/v1.3/nodes/group_by_node/#kapacitorloopback)
-	[Last](/kapacitor/v1.3/nodes/group_by_node/#last)
-	[Log](/kapacitor/v1.3/nodes/group_by_node/#log)
-	[Max](/kapacitor/v1.3/nodes/group_by_node/#max)
-	[Mean](/kapacitor/v1.3/nodes/group_by_node/#mean)
-	[Median](/kapacitor/v1.3/nodes/group_by_node/#median)
-	[Min](/kapacitor/v1.3/nodes/group_by_node/#min)
-	[Mode](/kapacitor/v1.3/nodes/group_by_node/#mode)
-	[MovingAverage](/kapacitor/v1.3/nodes/group_by_node/#movingaverage)
-	[Percentile](/kapacitor/v1.3/nodes/group_by_node/#percentile)
-	[Sample](/kapacitor/v1.3/nodes/group_by_node/#sample)
-	[Shift](/kapacitor/v1.3/nodes/group_by_node/#shift)
-	[Spread](/kapacitor/v1.3/nodes/group_by_node/#spread)
-	[StateCount](/kapacitor/v1.3/nodes/group_by_node/#statecount)
-	[StateDuration](/kapacitor/v1.3/nodes/group_by_node/#stateduration)
-	[Stats](/kapacitor/v1.3/nodes/group_by_node/#stats)
-	[Stddev](/kapacitor/v1.3/nodes/group_by_node/#stddev)
-	[Sum](/kapacitor/v1.3/nodes/group_by_node/#sum)
-	[Top](/kapacitor/v1.3/nodes/group_by_node/#top)
-	[Union](/kapacitor/v1.3/nodes/group_by_node/#union)
-	[Where](/kapacitor/v1.3/nodes/group_by_node/#where)
-	[Window](/kapacitor/v1.3/nodes/group_by_node/#window)
-->
...
To remove the measurement name from the group ID group the data by all existing dimensions but without specifying &#39;byMeasurement&#39;.
